        PROGRAM HW5
                ...
                CALL ELEMENT_MAT_TRI(dx, dy, A, kappa, m, heat_rate_list(l), elem_mat_3, b_vec_3)
                ...
                CALL ELEMENT_MAT_RECT(x_elem(:,l), y_elem(:,l), kappa, m, heat_rate_list(l), elem_mat_4, b_vec_4)
        ...
        SUBROUTINE ELEMENT_MAT_RECT(x, y, kappa, m, sigmaE, elem_mat, elem_b)
                ...
                nu = quad_points(2, k)
                CALL GET_QUAD(xi, nu, jac_inv, i, phi_i, dphi_i_x, dphi_i_y)
                elem_b(i) = elem_b(i) + phi_i * sigmaE
