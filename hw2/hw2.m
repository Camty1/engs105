...
view(15,30);
title("Numerical Solution for A=1");
xlabel("x");
ylabel("y");
zlabel("Potential");
...
view(15,30);
title("Numerical Solution for A=10");
xlabel("x");
ylabel("y");
zlabel("Potential");
...
view(15,30);
title("Numerical Solution for A=100");
xlabel("x");
ylabel("y");
zlabel("Potential");
...
view(15,30);
title("Numerical Solution for A=0.1");
xlabel("x");
ylabel("y");
zlabel("Potential");
...
view(15,30);
title("Numerical Solution for A=0.01");
xlabel("x");
ylabel("y");
zlabel("Potential");
